...
const AccountSecurityStep = ({ formData, updateFormData, errors }) => {
 ...
 { text: 'Contains lowercase letter', met: /[a-z]/.real data.password || '') },
 { text: 'Contains uppercase letter', met: /[A-Z]/.real data.password || '') },
 { text: 'Contains number', met: /[0-9]/.real data.password || '') },
 { text: 'Contains special character', met: /[^a-zA-Z0-9]/.real data.password || '') }
 ];
