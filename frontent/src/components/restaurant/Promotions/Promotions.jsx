...
const Promotions = () => {
  ...
  // Promotions data will be loaded from API
  const samplePromotions = [
    {
      id: 1,
      name: 'Weekend Special - 20% Off',
      description: 'Get 20% discount on all main course items during weekends',
      type: 'percentage',
      value: 20,
      minOrderAmount: 500,
      ...
      endDate: '2024-12-31',
      applicableItems: ['Chicken Momo', 'Dal Bhat', 'Veg Chowmein'],
      ...
      isPopular: true,
      targetAudience: 'all',
      deliveryArea: ['Kathmandu', 'Lalitpur', 'Bhaktapur'],
      conditions: 'Valid only on weekends (Saturday & Sunday)',
    ...
    },
    {
      ...
      description: 'Welcome new customers with NPR 100 off on first order',
      type: 'fixed',
      value: 100,
      minOrderAmount: 300,
      ...
      conditions: 'Only for first-time customers',
      termsAndConditions: 'Valid for 30 days after registration',
      stats: {
        totalUses: 156,
        totalSavings: 15600,
        conversionRate: 22.8,
    ...
    {
      id: 3,
      name: 'Buy 2 Get 1 Free - Momo',
      description: 'Buy any 2 momo plates and get 1 free',
      ...
      endDate: '2024-02-10',
      applicableItems: ['Chicken Momo', 'Veg Momo'],
      applicableCategories: ['Appetizers'],
      customerLimit: 5,
      usageLimit: 200,
      isActive: true,
      isPopular: true,
      targetAudience: 'all',
      deliveryArea: ['Kathmandu', 'Lalitpur'],
      conditions: 'Minimum 2 momo plates required',
      termsAndConditions: 'Free item will be the cheapest one',
      stats: {
        totalUses: 89,
        totalSavings: 16020,
        conversionRate: 18.5,
    ...
    },
    {
      ...
      description: 'Enjoy free delivery on all orders above NPR 400',
      type: 'free_delivery',
      value: 0,
      minOrderAmount: 400,
      ...
      termsAndConditions: 'Standard delivery charges waived',
      stats: {
        totalUses: 445,
        totalSavings: 22250,
        conversionRate: 25.3,
    ...
    },
    {
      ...
      deliveryArea: ['Kathmandu'],
      conditions: 'For customers with 10+ orders',
      termsAndConditions: 'Monthly usage limit applies',
      stats: {
        totalUses: 78,
        totalSavings: 11700,
        conversionRate: 12.5,
