...
const statCards = [
 ...
 return (
        <div key={index} className={`bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-all duration-200 ${stat.urgent ? 'ring-2 ring-yellow-400 ring-opacity-50' : ''}`}>
          <div className="flex items-center justify-between mb-4">
            <div className={`w-12 h-12 rounded-lg ${stat.bgColor} flex items-center justify-center shadow-sm`}>
              <Icon className={`${stat.icon === RupeeIcon ? 'text-lg' : 'w-6 h-6'} ${stat.iconColor}`} />
            </div>
            {stat.urgent && (
