    ...
    const mockTickets = [
      {
        ...
        message: 'My order was supposed to arrive at 6 PM but it\'s already 7:30 PM and I haven\'t received it yet.',
        status: 'open',
        priority: 'high',
        category: 'delivery',
      ...
      },
      {
        ...
        message: 'I would like to request a refund for my last order. The food was cold when it arrived.',
        status: 'in_progress',
        priority: 'medium',
        category: 'refund',
        ...
        replies: [
          {
            _id: 'r1',
            message: 'We have received your refund request and are processing it. You should receive the refund within 3-5 business days.',
            author: 'Finance Team',
      ...
      },
      {
        ...
        message: 'I can\'t log into my account. It keeps saying my password is incorrect.',
        status: 'resolved',
        priority: 'low',
        category: 'technical',
        ...
        replies: [
          {
            _id: 'r2',
            message: 'We have reset your password and sent you a new one via email. Please check your inbox.',
            author: 'Tech Support',
