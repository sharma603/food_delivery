    ...
    const mockReviews = [
      {
        ...
        comment: 'The food was absolutely delicious and arrived hot and fresh. The delivery was on time and the packaging was great. Will definitely order again!',
        images: [],
        status: 'approved',
      ...
      },
      {
        ...
        rating: 4,
        title: 'Good food, minor delivery delay',
        comment: 'The food was tasty and well-prepared. However, there was a slight delay in delivery, but the driver was very apologetic.',
        images: [],
        status: 'approved',
      ...
      },
      {
        ...
        comment: 'The pizza was cold when it arrived and the salad was wilted. Not what I expected for the price.',
        images: [],
        status: 'pending',
      ...
      },
      {
        ...
        rating: 5,
        title: 'Amazing authentic flavors!',
        comment: 'This is the best Indian food I\'ve had in a long time. The butter chicken was perfectly spiced and the naan was fresh and fluffy.',
        images: [],
        status: 'approved',
      ...
      },
      {
        ...
        comment: 'The burger was completely cold and the fries were soggy. The delivery took over an hour. Very disappointed.',
        images: [],
        status: 'flagged',
        createdAt: '2024-01-16T19:10:00Z',
        helpful: 1,
        verified: false
      }
    ];
