...
const AllMenuItems = () => {
 ...
 setEditImagePreview(`${backendUrl}${imageUrl}`);
 } else {
 ...
 // Update local state
 setMenuItems(prev =>
 prev.map(i => (i._id === editingItem._id ? { ...i, ...editFormData } : i))
 );
 ...
 <p className="text-xs text-gray-600 mb-2 line-clamp-1">{item.description || 'No description'}</p>
