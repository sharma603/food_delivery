...
console.log(' Backend is running on:', process.env.REACT_APP_API_URL || 'http://localhost:5000/api/v1');
...
fetchDashboardData(true);
 ...
 <div className="flex items-center space-x-6">
   <div className="flex items-center space-x-3 bg-white/60 backdrop-blur-sm rounded-lg px-4 py-2 shadow-sm">
     <div className={`w-3 h-3 rounded-full ${systemHealth.serverStatus === 'online' ? 'bg-green-500 animate-pulse' : 'bg-red-500'}`}></div>
     <span className="text-sm font-medium text-gray-700">Server</span>
   </div>
   <div className="flex items-center space-x-3 bg-white/60 backdrop-blur-sm rounded-lg px-4 py-2 shadow-sm">
     <div className={`w-3 h-3 rounded-full ${systemHealth.databaseStatus === 'connected' ? 'bg-green-500 animate-pulse' : 'bg-red-500'}`}></div>
     <span className="text-sm font-medium text-gray-700">Database</span>
   </div>
   <div className="flex items-center space-x-3 bg-white/60 backdrop-blur-sm rounded-lg px-4 py-2 shadow-sm">
     <div className="w-3 h-3 rounded-full bg-blue-500 animate-pulse"></div>
     <span className="text-sm font-medium text-gray-700">API: {systemHealth.apiResponseTime}ms</span>
   </div>
 </div>
 </div>
 ...
 Dismiss
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Common tasks</span>
          </div>
