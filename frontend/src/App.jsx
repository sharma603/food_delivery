...
import VerifyOTP from './components/auth/common/VerifyOTP';
import ResetPassword from './components/auth/common/ResetPassword';
import SuperAdminForgotPassword from './components/auth/common/SuperAdminForgotPassword';
import SuperAdminVerifyOTP from './components/auth/common/SuperAdminVerifyOTP';
import SuperAdminResetPassword from './components/auth/common/SuperAdminResetPassword';
    ...
    <AuthProvider>
      <NotificationProvider>
        ...
        <Routes>
          ...
          <Route path="/admin/forgot-password" element={<SuperAdminForgotPassword />} />
          <Route path="/admin/verify-otp" element={<SuperAdminVerifyOTP />} />
