...
const RestaurantOnboarding = ({ user, onLogout }) => {
 const menuItems = [
 ...
 return (
 <div className="restaurant-onboarding">
 ...
 <p>Welcome back, {user?.name || 'Admin'}! Manage restaurant applications and onboarding process.</p>
 </div>
 </div>
 </div>
 ...
 <h2><i className="fas fa-file-alt"></i> Recent Applications</h2>
 ...
 <span className="cuisine">{application.cuisine}</span>
 <span
 className="status"
 ...
 <span className="date">{application.submittedDate}</span>
 </div>
 ))}
 </div>
 </div>
