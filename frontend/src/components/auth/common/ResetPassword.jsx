...
import { Lock, AlertCircle, ChefHat, ArrowLeft, Eye, EyeOff, CheckCircle } from 'lucide-react';
...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${AppConfig.API.BASE_URL}/restaurant/auth/reset-password`, {
        method: 'POST',
        headers: {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-10 sm:pr-12 text-sm sm:text-base bg-white border border-gray-300 rounded-lg text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors"
