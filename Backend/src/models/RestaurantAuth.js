...
restaurantSchema.pre('save', function(next) {
  if (this.deliveryTime.max <= this.deliveryTime.min) {
...
restaurantSchema.statics.findByLocation = function(city, state, radius = 20) {
  return this.find({
...
const RestaurantAuth = mongoose.model('RestaurantAuth', restaurantSchema);
