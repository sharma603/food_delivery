...
export const createMobileOrder = async (req, res) => {
  try {
    ...
    // No tax calculation - tax will be set by admin if needed
    ...
    try {
      await sendEmail({
        ...
        data: {
          ...
          restaurantName: populatedOrder.restaurant.restaurantName,
          ...
          estimatedDelivery: populatedOrder.estimatedDeliveryTime.toLocaleString('en-US', {
            hour: 'numeric',
            minute: 'numeric'
          }),
